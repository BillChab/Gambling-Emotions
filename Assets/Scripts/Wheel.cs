					...
					switch (Slot)
					{
						...
						case 4:
							if (Bet.Equals("4"))
								...
								Victory(6);
							else if (Bet.Equals("1-2-4-5 Corner") || Bet.Equals("4-5-7-8 Corner"))
								Victory(9);
							else if (Bet.Equals("4-5-6 Street"))
								Victory(12);
							else if (Bet.Equals("1-4 Split") || Bet.Equals("4-5 Split") || Bet.Equals("4-7 Split"))
								Victory(18);
							break;
						...
						case 2:
							if (Bet.Equals("2"))
								...
								Victory(6);
							else if (Bet.Contains("Trio") || Bet.Equals("Basket") || Bet.Equals("1-2-4-5 Corner") || Bet.Equals("2-3-5-6 Corner"))
								Victory(9);
							else if (Bet.Equals("1-2-3 Street"))
								Victory(12);
							else if (Bet.Equals("1-2 Split") || Bet.Equals("2-3 Split") || Bet.Equals("2-5 Split"))
								Victory(18);
							break;
						...
						case 6:
							if (Bet.Equals("6"))
								...
								Victory(6);
							else if (Bet.Equals("2-3-5-6 Corner") || Bet.Equals("5-6-8-9 Corner"))
								Victory(9);
							else if (Bet.Equals("4-5-6 Street"))
								Victory(12);
							else if (Bet.Equals("3-6 Split") || Bet.Equals("5-6 Split") || Bet.Equals("6-9 Split"))
								Victory(18);
							break;
						...
						case 8:
							if (Bet.Equals("8"))
								...
								Victory(6);
							else if (Bet.Equals("4-5-7-8 Corner") || Bet.Equals("5-6-8-9 Corner") || Bet.Equals("7-8-10-11 Corner") || Bet.Equals("8-9-11-12 Corner"))
								Victory(9);
							else if (Bet.Equals("7-8-9 Street"))
								Victory(12);
							else if (Bet.Equals("5-8 Split") || Bet.Equals("7-8 Split") || Bet.Equals("8-9 Split") || Bet.Equals("8-11 Split"))
								Victory(18);
							break;
						...
						case 5:
							if (Bet.Equals("5"))
								...
								Victory(6);
							else if (Bet.Equals("1-2-4-5 Corner") || Bet.Equals("2-3-5-6 Corner") || Bet.Equals("4-5-7-8 Corner") || Bet.Equals("5-6-8-9 Corner"))
								Victory(9);
							else if (Bet.Equals("4-5-6 Street"))
								Victory(12);
							else if (Bet.Equals("2-5 Split") || Bet.Equals("4-5 Split") || Bet.Equals("5-6 Split") || Bet.Equals("5-8 Split"))
								Victory(18);
							break;
						...
						case 1:
							if (Bet.Equals("1"))
								...
								Victory(6);
							else if (Bet.Equals("Trio w/ 1") || Bet.Equals("Basket") || Bet.Equals("1-2-4-5 Corner"))
								Victory(9);
							else if (Bet.Equals("1-2-3 Street"))
								Victory(12);
							else if (Bet.Equals("1-2 Split") || Bet.Equals("1-4 Split"))
								Victory(18);
							break;
						...
						case 9:
							if (Bet.Equals("9"))
								...
								Victory(6);
							else if (Bet.Equals("5-6-8-9 Corner") || Bet.Equals("8-9-11-12 Corner"))
								Victory(9);
							else if (Bet.Equals("7-8-9 Street"))
								Victory(12);
							else if (Bet.Equals("6-9 Split") || Bet.Equals("8-9 Split") || Bet.Equals("9-12 Split"))
								Victory(18);
							break;
						...
						case 7:
							if (Bet.Equals("7"))
								...
								Victory(6);
							else if (Bet.Equals("4-5-7-8 Corner") || Bet.Equals("7-8-10-11 Corner"))
								Victory(9);
							else if (Bet.Equals("7-8-9 Street"))
								Victory(12);
							else if (Bet.Equals("4-7 Split") || Bet.Equals("7-8 Split") || Bet.Equals("7-10 Split"))
								Victory(18);
							break;
						...
						case 3:
							if (Bet.Equals("3"))
								...
								Victory(6);
							else if (Bet.Equals("Trio w/ 3") || Bet.Equals("Basket") || Bet.Equals("2-3-5-6 Corner"))
								Victory(9);
							else if (Bet.Equals("1-2-3 Street"))
								Victory(12);
							else if (Bet.Equals("2-3 Split") || Bet.Equals("3-6 Split"))
								Victory(18);
							break;
